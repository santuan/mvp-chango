    ...
    <div class="flex flex-1 flex-collg:flex-row">
      ...
      <section class="flex-1 p-6">
        ...
        >
          ...
          <span class="w-32 text-center text-lg font-semibold">Precio unidad</span>
          <span class="w-44 text-center text-lg font-semibold">Cantidad</span>
          <span class="w-32 text-center text-lg font-semibold">Total</span>
          <span class="w-16" />
        </div>
        ...
        <div class="max-h-[calc(100vh-15rem)] overflow-y-auto">
          ...
          >
            ...
            <span class="w-32 text-center text-lg font-semibold">{{ formatPrice(product.unitPrice) }}</span>
